...
func (sm *StorageProtocolSubmodule) clientEventLogger(event iface.ClientEvent, deal iface.ClientDeal) {
	log.Infof("Client Event: %s, Proposal CID: %s, State: %s, Message: %s", iface.ClientEvents[event], deal.ProposalCid, iface.DealStates[deal.State], deal.Message)
}

func (sm *StorageProtocolSubmodule) providerEventLogger(event iface.ProviderEvent, deal iface.MinerDeal) {
	log.Infof("Provider Event: %s, Proposal CID: %s, State: %s, Message: %s", iface.ProviderEvents[event], deal.ProposalCid, iface.DealStates[deal.State], deal.Message)
}
